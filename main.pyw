...
while True:
    ...
    if bksphold or larrhold or rarrhold:
        ...
        if holdbuff % 7 == 0:
            ...
            if rarrhold:
                textinput.manager.cursor_pos += 1 if textinput.manager.cursor_pos < len(
                    textinput.value) else 0
        holdbuff += 1
        ...
        if event.type == pygame.KEYDOWN:
            ...
            for ind in list(find_all(exp, '$$$')):
                ...
                while operBr < len(exp) and (not flagB or brB != 0):
                    if exp[operBr] == '(':
                        ...
                        brB -= 1
                    operBr += 1
                if brA != 0 or flagA == False or brB != 0 or flagB == False:
                    break
                rep(exp[operAl:operBr],
                    f"(not ({exp[operAl:operAr]} or {exp[operBl:operBr]}))"
                )
            ...
            for ind in list(find_all(exp, '&&&')):
                ...
                if brA != 0 or flagA == False or brB != 0 or flagB == False:
                    break
                rep(exp[operAl:operBr],
                    f"(not ({exp[operAl:operAr]} and {exp[operBl:operBr]}))"
                )
    ...
    pygame.draw.line(SCREEN,(20, 200, 20) if isvalid else (200, 20, 20), (20, 40), (SCREEN_WIDTH-20, 40))
